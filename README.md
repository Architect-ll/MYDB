...
mvn exec:java "-Dexec.mainClass=top.guoziyang.mydb.backend.Launcher" "-Dexec.args=-create D:\\JavaProjectLearning\\MYDB\\tmp\\mydb"
```
...
mvn exec:java "-Dexec.mainClass=top.guoziyang.mydb.backend.Launcher" "-Dexec.args=-open D:\\JavaProjectLearning\\MYDB\\tmp\\mydb"
```
